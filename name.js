...
var aboutHU = '<p class="paragraph">Szoftverfejlesztő tudásom alapját <strong><em>Java, JavaScript, HTML5, CSS3, MySQL, Git</em></strong> technológiák ismeretei alkotják.' + 
...
var aboutEN = '<p class="paragraph">My software development knowledge based on the next technologies: <strong><em>Java, JavaScript, HTML5, CSS3, MySQL, Git</em></strong>.' + 
